...
:Missing
    CALL FnEtcLogRun FnAiDispatch "fn=Fn%Input_Pascal%%Input_Suffix% suite=%Input_SuiteId% project=%Input_ProjectId% args=%Input_Args% projects=%Input_Projects% flags=%Input_Passthru%"
...
:Constructor
    ...
    SET "Input_Actions=claude:Claude"
...
:Usage
    CALL FnEtcLogError FnAiDispatch "%Input_Error%"
    SET "Input_Error="
...
:Destructor
    ...
    IF DEFINED Input_Error CALL FnEtcLogError FnAiDispatch "%Input_Error%"
