:: FnGitDispatch <SuiteId> <ProjectId> <ActionId> <Arg[]> <Flag[]>
:: leprechaun function git dispatch <SuiteId> <ProjectId> <ActionId> <Arg[]> <Flag[]>
:: -- Validates the action for the git module and invokes the leaf function:
:: --
:: --   FnGit<Action> SuiteId ProjectId --args ARGS... FLAGS...   (single project)
:: --   FnGit<Action> SuiteId --projects P... --args ARGS...      (selected projects)
:: --   FnGit<Action> SuiteId --args ARGS... FLAGS...             (all projects)
:: --
