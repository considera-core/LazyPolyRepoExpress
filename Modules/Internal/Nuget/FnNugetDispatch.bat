:: FnNugetDispatch --suite <SUITE> --action <ACTION> [--project <PROJECT>]
::               [-p <PROJECTS...>] [-a <ARGS...>] [FLAGS...]
:: -- Validates the action for the nuget module and invokes the leaf function
:: --
:: --   FnNuget<Action> SUITE PROJECT ARGS... FLAGS...          (single project)
:: --   FnNuget<Action> SUITE ARGS... -p PROJECTS... FLAGS...   (selected projects)
:: --   FnNuget<Action> SUITE ARGS... FLAGS...                  (all projects)
:: --
...
SET "M_ACTIONS=restore:Restore pack:Pack push:Push"
...
:MISSING_SUITE
    ECHO LeprechaunCLI:FnNugetDispatch[E]: Missing required flag --suite ^<SUITE^>
    GOTO :USAGE

:MISSING_ACTION
    ECHO LeprechaunCLI:FnNugetDispatch[E]: Missing action
    GOTO :USAGE

:UNKNOWN_ACTION
    ECHO LeprechaunCLI:FnNugetDispatch[E]: Unknown nuget action "%M_ACTION%"
    GOTO :USAGE
