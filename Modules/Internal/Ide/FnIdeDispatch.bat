:: FnIdeDispatch --suite <SUITE> --action <ACTION> [--project <PROJECT>]
::               [-p <PROJECTS...>] [-a <ARGS...>] [FLAGS...]
:: -- Validates the action for the ide module and invokes the leaf function
:: --
:: --   FnIde<Action> SUITE PROJECT ARGS... FLAGS...          (single project)
:: --   FnIde<Action> SUITE ARGS... -p PROJECTS... FLAGS...   (selected projects)
:: --   FnIde<Action> SUITE ARGS... FLAGS...                  (all projects)
:: --
...
SET "M_ACTIONS=code:Code jetbrains:Jetbrains rider:Rider webstorm:Webstorm"
...
:MISSING_SUITE
    ECHO LeprechaunCLI:FnIdeDispatch[E]: Missing required flag --suite ^<SUITE^>
    GOTO :USAGE

:MISSING_ACTION
    ECHO LeprechaunCLI:FnIdeDispatch[E]: Missing action
    GOTO :USAGE

:UNKNOWN_ACTION
    ECHO LeprechaunCLI:FnIdeDispatch[E]: Unknown ide action "%M_ACTION%"
    GOTO :USAGE
