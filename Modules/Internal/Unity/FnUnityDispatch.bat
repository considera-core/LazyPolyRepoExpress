...
:Missing
    CALL FnEtcLogRun FnUnityDispatch "fn=Fn%Function_Pascal%%Function_Suffix% suite=%Function_SuiteId% project=%Function_ProjectId% args=%Function_Args% projects=%Function_Projects% flags=%Function_Passthru%"
    IF DEFINED Function_DryRun GOTO Destructor
    SET "Function_Error=Not implemented yet: Fn%Function_Pascal%%Function_Suffix%"
    GOTO Failure

:Constructor
    SET "Function_Module=unity"
    SET "Function_Pascal=Unity"
    :: <action>:<function suffix>
    SET "Function_Actions=open:Open build:Build"
...
:Usage
    CALL FnEtcLogError FnUnityDispatch "%Function_Error%"
    SET "Function_Error="
...
:Destructor
    ...
    IF DEFINED Function_Error CALL FnEtcLogError FnUnityDispatch "%Function_Error%"
