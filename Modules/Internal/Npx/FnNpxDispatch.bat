:: FnNpxDispatch --suite <SUITE> --action <ACTION> [--project <PROJECT>]
::               [-p <PROJECTS...>] [-a <ARGS...>] [FLAGS...]
:: -- Validates the action for the npx module and invokes the leaf function
:: --
:: --   FnNpx<Action> SUITE PROJECT ARGS... FLAGS...          (single project)
:: --   FnNpx<Action> SUITE ARGS... -p PROJECTS... FLAGS...   (selected projects)
:: --   FnNpx<Action> SUITE ARGS... FLAGS...                  (all projects)
:: --
...
:MISSING_SUITE
    ECHO LeprechaunCLI:FnNpxDispatch[E]: Missing required flag --suite ^<SUITE^>
    GOTO :USAGE

:MISSING_ACTION
    ECHO LeprechaunCLI:FnNpxDispatch[E]: Missing action
    GOTO :USAGE

:UNKNOWN_ACTION
    ECHO LeprechaunCLI:FnNpxDispatch[E]: Unknown npx action "%M_ACTION%"
    GOTO :USAGE
